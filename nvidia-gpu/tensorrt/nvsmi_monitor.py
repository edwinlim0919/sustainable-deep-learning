...
async def get_nvsmi_info(gpu_type: str):
    ...
    for line in decoded_output.split('\n'):
        ...
        if ((gpu_type == 'v10032gb' and 'V100S-PCIE-32GB' in line) or
            ...
            (gpu_type == 'p10016gb' and 'P100-PCIE-16GB' in line)):
            curr_GPU += 1
            nvsmi_dict[curr_GPU] = {}
...
def main(args):
    ...
    with (output_dir / args.output_file).open('w') as f:
        ...
        elif args.gpu_type == 'p10016gb':
            f.write(f'nvsmi profiling: P100-PCIE-16GB\n')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help='specify v10032gb, a10040gb, or p10016gb for parsing nvsmi output'
    )
