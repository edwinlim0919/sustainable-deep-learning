...
# fp16 nowq batch 384
python3 benchmarking/nvsmi_monitor.py --output_dir outputs/gpt/137M/fp16/1-gpu-384-batch --output_file nvsmi_numreqsample0_iter100_max500_a10040gb.out --container_id 156096f113ad --container_output_dir /TensorRT-LLM/examples/gpt --container_stop_file container_stop.txt --gpu_type a10040gb
...
sudo docker cp 156096f113ad:/TensorRT-LLM/examples/gpt/outputs/gpt/137M/fp16/1-gpu-384-batch/bmark_numreqsample0_iter100_max500_a10040gb.out ../outputs/gpt/137M/fp16/1-gpu-384-batch/bmark_numreqsample0_iter100_max500_a10040gb.out
