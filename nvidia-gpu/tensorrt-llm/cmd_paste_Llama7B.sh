...
# Q4 EXPERIMENTS
python ../benchmark_trtllm.py --tokenizer_dir ./meta-llama/Llama-2-7b-chat-hf_tokenizer/ --engine_dir ./llama/7B/trt_engines/fp16_q4/1-gpu-1-batch/ --dataset_path ../ShareGPT_V3_unfiltered_cleaned_split.json --num_requests_sample 0 --max_batch_size 1 --max_input_tokens 1000 --max_output_tokens 1000 --output_dir ./outputs/llama/7B/fp16_q4/1-gpu-1-batch --output_file bmark_numreqsample0_iter10_max1000_a10040gb.out --random_seed 42 --num_iterations 100 --use_prompt_formatting --add_special_tokens
