...
# experiments
# 1 gpu 1 batch 500 max TODO: is this a fair comparison against Llama2? max sequence length for gpt2 is 1024
# /dev/shm/sustainable-deep-learning/nvidia-gpu/tensorrt-llm
